...
//  FirebaseLoginApp
//
//  Created by Gilbert Gonzalez on 3/30/21.
//
...
class ChatViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "MessageCellTableViewCell", bundle: nil), forCellReuseIdentifier: "Message Cell Table View Cell")
...
extension ChatViewController: UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "Message Cell Table View Cell", for: indexPath) as! MessageCellTableViewCell
